...
class UuidGen extends Eloquent{
  ...
  public static function generateUuid($nickname){
    try {
        ...
        //$uuid1 = Uuid::uuid1( ( "OfflinePlayer:" + $nickname ) );
        //echo $uuid1->toString() . "<br>"; // i.e. e4eaaaf2-d142-11e1-b3e4-080027620cdd

        // Generate a version 3 (name-based and hashed with MD5) UUID object
        //$uuid3 = Uuid::uuid3(Uuid::NAMESPACE_DNS, ( "OfflinePlayer:" + $nickname ) );
        ...
        //$uuid5 = Uuid::uuid5(Uuid::NAMESPACE_DNS, ( "OfflinePlayer:" + $nickname ) );
